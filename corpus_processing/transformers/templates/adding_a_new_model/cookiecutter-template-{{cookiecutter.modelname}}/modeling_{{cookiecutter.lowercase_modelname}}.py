...
class {{cookiecutter.camelcase_modelname}}Attention(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.self = {{cookiecutter.camelcase_modelname}}
        SelfAttention(config)
        self.output = {{cookiecutter.camelcase_modelname}}
        SelfOutput(config)
...
class {{cookiecutter.camelcase_modelname}}Layer(nn.Module):
    def __init__(self, config):
        ...
        self.seq_len_dim = 1
        self.attention = {{cookiecutter.camelcase_modelname}}
        Attention(config)
        self.is_decoder = config.is_decoder
        self.add_cross_attention = config.add_cross_attention
        if self.add_cross_attention:
            assert self.is_decoder, f"{self} should be used as a decoder model if cross attention is added"
            self.crossattention = {{cookiecutter.camelcase_modelname}}
            Attention(config)
        self.intermediate = {{cookiecutter.camelcase_modelname}}
        Intermediate(config)
        self.output = {{cookiecutter.camelcase_modelname}}
        Output(config)
...
class {{cookiecutter.camelcase_modelname}}Encoder(nn.Module):
    def __init__(self, config):
        ...
        self.layer = nn.ModuleList(
            [{{cookiecutter.camelcase_modelname}}Layer(config) for _ in range(config.num_hidden_layers)])
    ...
    class {{cookiecutter.camelcase_modelname}}LMPredictionHead(nn.Module):
        def __init__(self, config):
            super().__init__()
            self.transform = {{cookiecutter.camelcase_modelname}}
            PredictionHeadTransform(config)
    ...
    class {{cookiecutter.camelcase_modelname}}OnlyMLMHead(nn.Module):
        def __init__(self, config):
            super().__init__()
            self.predictions = {{cookiecutter.camelcase_modelname}}
            LMPredictionHead(config)
...
"""
    ...
    class {{cookiecutter.camelcase_modelname}}Model({{cookiecutter.camelcase_modelname}}PreTrainedModel):
        ...
        def __init__(self, config):
            ...
            self.embeddings = {{cookiecutter.camelcase_modelname}}
            Embeddings(config)
            self.encoder = {{cookiecutter.camelcase_modelname}}
            Encoder(config)
    ...
    class {{cookiecutter.camelcase_modelname}}ForMaskedLM({{cookiecutter.camelcase_modelname}}PreTrainedModel):
        def __init__(self, config):
            ...
            Model(config)
            self.cls = {{cookiecutter.camelcase_modelname}}
            OnlyMLMHead(config)
    ...
    class {{cookiecutter.camelcase_modelname}}ForSequenceClassification({{cookiecutter.camelcase_modelname}}PreTrainedModel):
        def __init__(self, config):
            ...
            {{cookiecutter.lowercase_modelname}} = {{cookiecutter.camelcase_modelname}}
            Model(config)
            self.classifier = {{cookiecutter.camelcase_modelname}}
