...
{{cookiecutter.camelcase_modelname}}
Config
...
class TF{{cookiecutter.camelcase_modelname}}Attention(tf.keras.layers.Layer):
    def __init__(self, config, **kwargs):
        ...
        self.self_attention = TF
        {{cookiecutter.camelcase_modelname}}
        SelfAttention(config, name="self")
        self.dense_output = TF
        {{cookiecutter.camelcase_modelname}}
        SelfOutput(config, name="output")
...
class TF{{cookiecutter.camelcase_modelname}}Layer(tf.keras.layers.Layer):
    def __init__(self, config, **kwargs):
        ...
        self.attention = TF
        {{cookiecutter.camelcase_modelname}}
        Attention(config, name="attention")
        self.intermediate = TF
        {{cookiecutter.camelcase_modelname}}
        Intermediate(config, name="intermediate")
        self.
        {{cookiecutter.lowercase_modelname}}
        _output = TF
        {{cookiecutter.camelcase_modelname}}
    ...
    def call(self, hidden_states, attention_mask, head_mask, output_attentions, training=False):
        ...
        layer_output = self.
        {{cookiecutter.lowercase_modelname}}
        _output(intermediate_output, attention_output, training=training)
...
class TF{{cookiecutter.camelcase_modelname}}Encoder(tf.keras.layers.Layer):
    def __init__(self, config, **kwargs):
        ...
        self.layer = [TF{{cookiecutter.camelcase_modelname}}Layer(config, name="layer_._{}".format(i))
...
class TF{{cookiecutter.camelcase_modelname}}LMPredictionHead(tf.keras.layers.Layer):
    def __init__(self, config, input_embeddings, **kwargs):
        ...
        self.transform = TF
        {{cookiecutter.camelcase_modelname}}
        PredictionHeadTransform(config, name="transform")
...
class TF{{cookiecutter.camelcase_modelname}}MLMHead(tf.keras.layers.Layer):
    def __init__(self, config, input_embeddings, **kwargs):
        ...
        self.predictions = TF
        {{cookiecutter.camelcase_modelname}}
        LMPredictionHead(config, input_embeddings, name="predictions")
...
class TF{{cookiecutter.camelcase_modelname}}MainLayer(tf.keras.layers.Layer):
    config_class = {{cookiecutter.camelcase_modelname}}
    Config
    ...
    def __init__(self, config, **kwargs):
        ...
        self.embeddings = TF
        {{cookiecutter.camelcase_modelname}}
        Embeddings(config, name="embeddings")
        self.encoder = TF
        {{cookiecutter.camelcase_modelname}}
        Encoder(config, name="encoder")
        self.config = config
...
class TF{{cookiecutter.camelcase_modelname}}Model(TF{{cookiecutter.camelcase_modelname}}PreTrainedModel):
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.
        {{cookiecutter.lowercase_modelname}} = TF
        {{cookiecutter.camelcase_modelname}}
        MainLayer(config, name="{{cookiecutter.lowercase_modelname}}")
    ...
    def call(self, inputs, **kwargs):
        outputs = self.
        {{cookiecutter.lowercase_modelname}}(inputs, **kwargs)

        return outputs


@add_start_docstrings("""{{cookiecutter.modelname}} Model with a `language modeling` head on top. """,
                      {{cookiecutter.uppercase_modelname}}
...
class TF{{cookiecutter.camelcase_modelname}}ForMaskedLM(TF{{cookiecutter.camelcase_modelname}}PreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def __init__(self, config, *inputs, **kwargs):
        ...
        {{cookiecutter.camelcase_modelname}}
        MLMHead(config, self.
        {{cookiecutter.lowercase_modelname}}.embeddings, name = "mlm___cls")

        def get_output_embeddings(self):
            return self.
            {{cookiecutter.lowercase_modelname}}.embeddings
        ...
        def call(
            ...
            {{cookiecutter.lowercase_modelname}}.return_dict
    ...
    class TF{{cookiecutter.camelcase_modelname}}ForSequenceClassification(TF{{cookiecutter.camelcase_modelname}}PreTrainedModel, TFSequenceClassificationLoss):
        def __init__(self, config, *inputs, **kwargs):
            ...
            self.classifier = TF
            {{cookiecutter.camelcase_modelname}}
            ClassificationHead(config, name="classifier")
        ...
        def call(
            ...
            """
            return_dict = return_dict if return_dict is not None else self.
            {{cookiecutter.lowercase_modelname}}.config.return_dict
    ...
    class TF{{cookiecutter.camelcase_modelname}}ForMultipleChoice(TF{{cookiecutter.camelcase_modelname}}PreTrainedModel, TFMultipleChoiceLoss):
        ...
        _INPUTS_DOCSTRING.format("batch_size, num_choices, sequence_length"))
